  ...
  <v-container class="fill-height">
    <v-responsive class="align-centerfill-height mx-auto" max-width="900">
      ...
      <v-row>
        ...
        <v-col cols="6">
          <v-card append-icon="mdi-open-in-new" class="py-4" color="surface-variant" href="Register"
            prepend-icon="mdi-star-circle-outline" rel="noopener noreferrer" rounded="lg" subtitle="Registro papu."
            title="Register" variant="text">
            <v-overlay opacity=".06" scrim="primary" contained model-value persistent />
          </v-card>
        </v-col>
        ...
        <v-col cols="6">
          <v-card append-icon="mdi-open-in-new" class="py-4" color="surface-variant" href="Login"
            prepend-icon="mdi-account-group-outline" rel="noopener noreferrer" rounded="lg" subtitle="Login papu."
            title="Login" variant="text">
            <v-overlay opacity=".06" scrim="primary" contained model-value persistent />
          </v-card>
        </v-col>
      </v-row>
